...
# /SBZoom/gangse0/
def index(request):
    return render(request, 'guro/index.html', {'guzip':guzip})
...
def eatOut(request):
    ...
    title=['구로구 외식업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
     
    ana_zip = list(zip(qlist,ilban,franchise,total,sales))  

    
    return render(request, 'guro/eatOut.html', {'guzip':guzip,'title':title, 'qlist':qlist, 'ilban':ilban,'franchise':franchise,'total':total,'sales':sales,'ana_zip':ana_zip})
...
def service(request):
    ...
    title=['구로구 서비스업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'guro/service.html',context)
...
def retail(request):
    ...
    title=['구로구 소매업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'guro/retail.html', context)
...
def total(request):
    ...
    title=['구로구 전체 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'guro/total.html', context)
...
def ilban(request):
    ...
    title=['구로구 일반점포 현황','외식업','서비스업','소매업','전체일반점포']
    ...
    return render(request, 'guro/ilban.html', context)
...
def franchise(request):
    ...
    title=['구로구 프렌차이즈 현황','외식업','서비스업','소매업','전체일반점포']
    ...
    return render(request, 'guro/franchise.html', context)
...
def totalStores(request):
    ...
    title=['구로구 전체 점포 현황','외식업','서비스업','소매업','전체일반']
    ...
    return render(request, 'guro/totalStores.html', context)
...
def totalSales(request):
    ...
    title=['구로구 전체 점포 현황','외식업 매출액(억)','서비스업 매출액(억)','소매업 매출액(억)','전체 매출액(억)']
    ...
    return render(request, 'guro/totalSales.html', context)
