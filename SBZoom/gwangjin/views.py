...
# /SBZoom/gangse0/
def index(request):
    return render(request, 'gwangjin/index.html', {'guzip':guzip})
...
def eatOut(request):
    ...
    title=['광진구 외식업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
     
    ana_zip = list(zip(qlist,ilban,franchise,total,sales))  

    
    return render(request, 'gwangjin/eatOut.html', {'guzip':guzip,'title':title, 'qlist':qlist, 'ilban':ilban,'franchise':franchise,'total':total,'sales':sales,'ana_zip':ana_zip})
...
def service(request):
    ...
    title=['광진구 서비스업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'gwangjin/service.html',context)
...
def retail(request):
    ...
    title=['광진구 소매업 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'gwangjin/retail.html', context)
...
def total(request):
    ...
    title=['광진구 전체 상권 현황','일반 점포','프렌차이즈','전체','매출액(억)']
    ...
    return render(request, 'gwangjin/total.html', context)
...
def ilban(request):
    ...
    title=['광진구 일반점포 현황','외식업','서비스업','소매업','전체일반점포']
    ...
    return render(request, 'gwangjin/ilban.html', context)
...
def franchise(request):
    ...
    title=['광진구 프렌차이즈 현황','외식업','서비스업','소매업','전체일반점포']
    ...
    return render(request, 'gwangjin/franchise.html', context)
...
def totalStores(request):
    ...
    title=['광진구 전체 점포 현황','외식업','서비스업','소매업','전체일반']
    ...
    return render(request, 'gwangjin/totalStores.html', context)
...
def totalSales(request):
    ...
    title=['광진구 전체 점포 현황','외식업 매출액(억)','서비스업 매출액(억)','소매업 매출액(억)','전체 매출액(억)']
    ...
    return render(request, 'gwangjin/totalSales.html', context)
